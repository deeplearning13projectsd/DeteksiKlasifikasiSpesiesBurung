...
def add_custom_header():
    ...
    <body margin: 20px;">
        <div style="text-align: center; margin-top: 30px; padding: 10px"> 
            ...
            <img src="https://raw.githubusercontent.com/deeplearning13projectsd/DeteksiKlasifikasiSpesiesBurung/main/Deployment/asset/avcla.png" alt="Logo kelompok" width="105" height="105">
        </div>
